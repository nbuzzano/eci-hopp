...
def start_experiment():
	...
	models = {}
	for code, train_prices_per_stock in train_prices.groupby("SecuritiesCode"):
		
		train_prices_per_stock = train_prices_per_stock[~train_prices_per_stock["Target"].isnull()]
		x = train_prices_per_stock[columns]
		y = train_prices_per_stock.Target
